...
if("TRUE" STREQUAL "TRUE")
  set(realsense_SOURCE_PREFIX /root/catkin_ws/src/realsense)
  set(realsense_DEVEL_PREFIX /root/catkin_ws/devel)
  ...
  set(realsense_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'realsense' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/realsense/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(realsense_EXPORTED_TARGETS ${${realsense_dep}_EXPORTED_TARGETS})
endforeach()
